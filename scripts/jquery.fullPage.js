        ...
        */
        ...
        function bindEvents(){
            ...
            $document
                ...
                .keyup(keyUpHandler)
                //Add animation to flags
                .keyup(function(event) {
                         if(event.which == 37 || event.which == 39) {
                           $(".flags").addClass("animated pulse").one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend',
                             function(){
            ...
            //Add animation to flags
            $(SECTION_SEL).on('click touchstart', function(){
                    $(".flags").addClass("animated pulse").one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend',
                      function(){
                        $(this).removeClass("animated pulse");
                    });
